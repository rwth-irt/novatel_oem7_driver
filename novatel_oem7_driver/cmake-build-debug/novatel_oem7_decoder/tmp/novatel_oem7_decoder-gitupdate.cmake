...
execute_process(
  COMMAND "/usr/bin/git" show-ref "origin/dev-ros_install_prefix"
  WORKING_DIRECTORY "/home/haoming/fgo_ws/src/fgo_code/novatel_oem7_driver/cmake-build-debug/novatel_oem7_decoder/src/novatel_oem7_decoder"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "origin/dev-ros_install_prefix")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("origin/dev-ros_install_prefix" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/origin/dev-ros_install_prefix")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/haoming/fgo_ws/src/fgo_code/novatel_oem7_driver/cmake-build-debug/novatel_oem7_decoder/src/novatel_oem7_decoder'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/haoming/fgo_ws/src/fgo_code/novatel_oem7_driver/cmake-build-debug/novatel_oem7_decoder/src/novatel_oem7_decoder'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
